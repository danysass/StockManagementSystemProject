...
{
    public partial class PurchaseReturnListForm : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private DataTable Gethead()
        {
            ...
            try
            {
                ...
                con.Open();
                string sql = @"select * from PurchaseReturnHead";
        ...
        private void ListGridView_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if(ListGridView.RowCount>0)
                {
                    ...
                    PurchaseReturnForm FormDetail = new PurchaseReturnForm();
                    FormDetail._Id = id;
                    FormDetail.record = PurchaseReturnForm.RecordFlag.Edit;
