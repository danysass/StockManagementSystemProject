...
{
    public partial class StockRequestDeliveryListForm : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        public StockRequestDeliveryListForm()
        {
            InitializeComponent();
        }
        ...
        private DataTable Gethead()
        {
            ...
            try
            {
                ...
                con.Open();
                string sql = @"select * from StockRequisitionDeliveryHead";
        ...
        private void PurchaseOrderListForm_Shown(object sender, EventArgs e)
        {
            try
            {
                ...
                repositoryItemLookUpEdit1.DataSource = ValueListClass.GetFullList("VLDepartment");
        ...
        private void ListGridView_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if(ListGridView.RowCount>0)
                {
                    ...
                    StockRequestDeliveryForm FormDetail = new StockRequestDeliveryForm();
                    FormDetail._Id = id;
                    FormDetail.record = StockRequestDeliveryForm.RecordFlag.Edit;
        ...
        private void Last30DaysBtn_ItemClick(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                BinaryOperator op1 = new BinaryOperator("DeliveryDate", start, BinaryOperatorType.GreaterOrEqual);
                BinaryOperator op2 = new BinaryOperator("DeliveryDate", end, BinaryOperatorType.Less);
