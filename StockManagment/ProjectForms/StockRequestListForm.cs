...
{
    public partial class StockRequestListForm : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        public StockRequestListForm()
        {
            InitializeComponent();
        }
        ...
        private DataTable Gethead()
        {
            ...
            try
            {
                ...
                con.Open();
                string sql = @"select * from StockRequisitionHead";
 ...
 repositoryItemLookUpEdit1.DataSource = ValueListClass.GetFullList("VLDivision");
        ...
        private void ListGridView_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if(ListGridView.RowCount>0)
                {
                    ...
                    StockRequestForm FormDetail = new StockRequestForm();
                    FormDetail._Id = id;
                    FormDetail.record = StockRequestForm.RecordFlag.Edit;
        ...
        private void Last30DaysBtn_ItemClick(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                BinaryOperator op1 = new BinaryOperator("RequisitionDate", start, BinaryOperatorType.GreaterOrEqual);
                BinaryOperator op2 = new BinaryOperator("RequisitionDate", end, BinaryOperatorType.Less);
