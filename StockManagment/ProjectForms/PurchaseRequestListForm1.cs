...
{
    public partial class PurchaseRequestListForm1 : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        public PurchaseRequestListForm1()
        {
            InitializeComponent();
        }
        ...
        private DataTable Gethead()
        {
            ...
            try
            {
                ...
                con.Open();
                string sql = @"select * from PurchaseRequestHead";
        ...
        private void PurchaseOrderListForm_Shown(object sender, EventArgs e)
        {
            try
            {
                ...
                repositoryItemLookUpEdit1.DataSource = ValueListClass.GetUsers();
        ...
        private void ListGridView_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if(ListGridView.RowCount>0)
                {
                    ...
                    PurchaseRequestForm FormDetail = new PurchaseRequestForm();
                    FormDetail._Id = id;
                    FormDetail.record = PurchaseRequestForm.RecordFlag.Edit;
        ...
        private void Last30DaysBtn_ItemClick(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                BinaryOperator op1 = new BinaryOperator("RequestDate", start, BinaryOperatorType.GreaterOrEqual);
                BinaryOperator op2 = new BinaryOperator("RequestDate", end, BinaryOperatorType.Less);
